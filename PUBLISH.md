...
powershell -ExecutionPolicy Bypass -File scripts/publish-devkit.ps1 -Version 0.1.0-preview.7
```
...
1. Pack in the private monorepo (`scripts/pack-polystack.ps1 -Profile DevKit -Version 0.1.0-preview.7`).
2. Create a GitHub **Release** on `getpolystack/devkit` (e.g. tag `v0.1.0-preview.7`) and attach every `.nupkg`.
